...
public class ReturnBook extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        }else
        {
            ...
            double fee = librarianRolePointer.returnBook(studentId, bookId, bDate);
            System.out.println("fee in return book" + fee);
            if(fee == -1)
                message = "This borrowing operation is not found";
            else
                message = "The student with id = " + studentId + " should pay a return fee of "+ fee+" US dollars for the book with id " + bookId;
        }
