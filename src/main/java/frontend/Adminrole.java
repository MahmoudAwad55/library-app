...
public class Adminrole extends javax.swing.JFrame {
  ...
  public static AdminRole functions=new AdminRole();
AddLibrarian add=new AddLibrarian();
RemoveLibrarian remove=new RemoveLibrarian();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        LibrarianUser usersinfo[]=functions.getListOfLibrarians();
        String [][]tabledata=new String[usersinfo.length][5];
        for(int i=0;i<usersinfo.length;i++){
        tabledata[i]=usersinfo[i].lineRepresentation().split(",");
